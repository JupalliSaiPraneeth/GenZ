...
export default function AdminDashboard() {
  return (
    <div className="relative min-h-screen w-full bg-[#FAF7F0] overflow-x-hidden">
      ...
      <div className="relative z-10 pt-[95px] sm:pt-[125px] pb-16 px-3 sm:px-6 max-w-7xl mx-auto space-y-6 sm:space-y-8">

        {/* Top Header */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/20 pb-6">
          <div>
            {/* COMBO 04 Pill Badge */}
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-white/15 text-white font-mono text-[11px] sm:text-xs font-bold border border-white/25 backdrop-blur-xs shadow-md">
              <span className="text-[#FDE7B5]">COMBO 04</span>
              <span className="text-white/40">•</span>
              <span className="text-[#FFF8E8]">Hex → #109A9B & #FDE7B5</span>
            </div>
            <h1 className="font-heading font-extrabold text-2xl sm:text-3xl text-[#FFF8E8] mt-2 drop-shadow-xs">
              Research Intelligence Dashboard
            </h1>
          </div>
          <div className="flex items-center gap-3">
            <span className="px-3.5 py-1.5 bg-emerald-500/20 text-emerald-100 text-xs font-bold rounded-full border border-emerald-400/40 backdrop-blur-xs flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#109A9B]/20 shadow-xl flex items-center justify-between">
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-[#109A9B]/20 shadow-xl">
          ...
          {/* Quick Admin Actions */}
          <div className="bg-[#075D63] text-[#FFF8E8] p-6 rounded-3xl border border-[#063E46] space-y-6 shadow-xl">
