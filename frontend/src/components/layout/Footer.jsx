...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#075D63] text-[#FFF8E8] pt-12 sm:pt-16 pb-8 sm:pb-12 border-t border-[#063E46] relative overflow-hidden">
      {/* Glow Effect */}
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-8 sm:mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-[#FFF8E8]/90 text-xs sm:text-sm leading-relaxed mb-3 font-medium">
              “Your Perspective. A Brighter Tomorrow.”
            </p>
            <p className="text-[11px] sm:text-xs text-[#FFF8E8]/70">
          ...
          <div>
            <h4 className="font-heading font-bold text-[#FDE7B5] mb-3 sm:mb-4 uppercase tracking-wider text-xs">
              Research Dimensions
            </h4>
          ...
          <div className="bg-[#063E46]/60 p-4 sm:p-5 rounded-2xl border border-white/10">
            <div className="flex items-center gap-2 text-[#FDE7B5] mb-2 font-semibold text-xs sm:text-sm">
              <Shield className="w-4 h-4" />
              <span>Research Integrity Guarantee</span>
            </div>
            <p className="text-[11px] sm:text-xs text-[#FFF8E8]/80 leading-relaxed mb-3 font-medium">
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/10 text-center text-xs text-[#FFF8E8]/70 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 font-medium">
          ...
          <div className="flex items-center gap-3 sm:gap-6 text-[11px] sm:text-xs text-[#FFF8E8]/70">
            ...
            <span>•</span>
            <span>{getStoredQuestions().length} Questions</span>
            <span>•</span>
